...
1. You must have Node.js 18 or later installed in your machine
...
5. Create a file in `animejs-tutorial/src` with a name `n-body-simulation.md`

6. Install animejs by opening a new terminal and change your terminal
