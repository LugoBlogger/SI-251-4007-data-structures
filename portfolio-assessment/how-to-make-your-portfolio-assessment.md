...
To write your portfolio assessment, you need to follow strictly to all these 
rules. 

1. Prepare a file in `draw.io` with the size of A4 paper.
   Draw a margin with a distance around 4 boxes to all the edges of
   A4 paper layout.
   ...
   You can use the given template [here](./template-portfolio-assessment.drawio).

   Rename your `.drawio` file with the following format:   
   `[student-id]-[full-name]`,    
   Ex: `10221000-Henokh-Lugo-Hariyanto.drawio`
   

3. In each week, you have to write at least four pages of A4 in your 
